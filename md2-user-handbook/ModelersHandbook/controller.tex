...
The \textit{remote connection} allows to specify a URI for the backend communication as well as a path to specify the storage location of files to be uploaded. The backend must comply with the MD2 web service interface as specified in the appendix. \todo{Wir haben noch keinen Appendix @ALL}
\begin{lstlisting}
