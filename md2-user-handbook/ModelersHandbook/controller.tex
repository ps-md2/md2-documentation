...
Instead of the aforementioned settings, a process chain that will become active while this process chain step is the current one, can be referenced\todo{Rephrase}.
\begin{lstlisting}
step NAME:
...
\todo{How is this related to the ProcessChain?}
