...
\lstdefinelanguage{MD2}{
  ...
  defaultConnection, CustomAction, CombinedAction, CustomCodeFragement, SimpleAction, WebServiceCallAction, WebServiceCall, externalWebService, url, method, GET, POST, PUT, DELETE, queryparams, bodyparams, on, from, Container, Content, processChain,
...
\lstset{
	...
	breaklines=true,
	breakatwhitespace=false, %also break at non-whitespace points!
	tabsize=3
}
%\usepackage{caption} 
...
\LARGE Project Seminar\\ Model-driven Mobile Development\\[1.5cm] % Name of your university/college
...
\newcommand*\theaddchap[1]{
	...
	\renewcommand*{\theHsection}{ch#1.\the\value{section}}
}
...
\input{DevelopersHandbook/42-Preprocessor}
