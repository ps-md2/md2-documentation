...
The static \mapapps code is split into several bundles, which are then used by the generated \mapapps code. These bundles are located at \lstinline!src/main/js/bundles! \todo{@JULE Keywords nur highlighten wenn freigestellt} and are explained in the following subsections.
...
\subsubsection{Runtime}\todo{@TOBI @JAN @ANDI Add descriptions of folders: 
contentprovider, 
datamapper, 
datatypes, 
entities, 
...
\paragraph{MD2MainWidget}\todo{@TOBI review}
...
\paragraph{Workflow}\todo{@TOBI Erlaeuterung der transactionID im WorkflowStateHandler + Erlaeuterung vom WorkflowStateTransaction.js fehlt noch...}
...
\subsubsection{Event handler} \todo{@TOBI @JULE @CARO Please give me a description...}
...
\subsubsection{Workflow state} \todo{@TOBI @JULE @CARO Please give me a description...}
