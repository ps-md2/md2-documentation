...
\node[draw] (tool) at (-1.25, -1.75) {\small{map.apps tool}};

\draw [->, thick, ercisred] (tool) -- (4.25,-1.75) node[above, arrowlbl] {startWorkflowFromTool} -- (4.25,0.5) -- (5,0.5);
...
\draw [->, thick, ercisred] (2,0.65) -- node[above, arrowlbl] {build} (5,0.65);
